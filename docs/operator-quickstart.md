# Operator Quickstart — Activities of amusement parks and theme parks

Shortest path from clone to a verified local dry-run for **ISIC 9321** (`cloud-itonami-isic-9321`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-9321.git
cd cloud-itonami-isic-9321
```
...
- Blueprint governor key: `ride-safety-governor`
- Likely source path: `parksafety.governor.cljc`
